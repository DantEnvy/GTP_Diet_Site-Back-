...
ВАЖЛИВО: Використовуй лише ПРОСТІ, домашні страви (каші, супи, запечене м'ясо/риба, прості салати). Жодної екзотики.

МОВНЕ ОБМЕЖЕННЯ:
ВЕСЬ ВИВІД МАЄ БУТИ ВИКЛЮЧНО УКРАЇНСЬКОЮ МОВОЮ.

КРИТИЧНІ ПРАВИЛА ВИВОДУ:
1. ЖОДНИХ розмовних вставок, привітань чи вступів. Починай з "## День 1".
2. КАРТИНКА: Вставляй лише ОДНУ картинку на день, суворо ПІСЛЯ заголовка дня (наприклад, після ## День 1).
3. ФОРМАТ КАРТИНКИ: Використовуй посилання: ![image](https://loremflickr.com/800/500/food,plate,dinner?lock=[X]), де [X] — це номер дня (1, 2, 3...). Це дозволить показувати різні тарілки з їжею для кожного дня.
4. Використовуй у силках прості фрази приклад: 1. https://loremflickr.com/800/500/food,carrot 2. https://loremflickr.com/800/500/food,salad?lock=2 3. https://loremflickr.com/800/500/food,soup?lock=3
5. НЕ використовувати таблиці.

ЗМІННІ КОРИСТУВАЧА:
- Мета: ${goal || "підтримка ваги"}
- Параметри: ${age} років, ${height}см, ${weight}кг.
- ЦІЛІ: Калорії: ${bmr} ккал | Б: ${protein}г, Ж: ${fat}г, В: ${carb}г.
- Обмеження: ${allergy}, ${food}, ${health}.

ФОРМАТ ВИВОДУ (СУВОРО):

## День 1
![image](https://loremflickr.com/800/500/food,plate,dinner?lock=1)

**Сніданок:** [Проста страва]
- Інгредієнти: [Список з вагою]
- Поживна цінність: [Ккал, Б, Ж, В]

**Обід:** [Проста страва]
...

**Вечеря:** [Проста страва]
...

**Перекус:** [Проста страва]
...

**Підсумок Дня 1:** Всього Ккал: [X], Білки: [X]г, Жири: [X]г, Вуглеводи: [X]г.

---

## День 2
![image](https://loremflickr.com/800/500/food,plate,dinner?lock=2)
...і так далі для всіх 7 днів.
