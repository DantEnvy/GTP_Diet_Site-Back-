...
ВАЖЛИВО: Страви мають бути максимально ПРОСТИМИ, звичайними та доступними (домашня кухня: каші, овочі, курка, яйця). Уникай екзотики.

МОВНЕ ОБМЕЖЕННЯ:
ВЕСЬ ВИВІД МАЄ БУТИ ВИКЛЮЧНО УКРАЇНСЬКОЮ МОВОЮ (окрім англійських тегів у посиланнях).

КРИТИЧНІ ПРАВИЛА ВИВОДУ:
1. ЖОДНИХ розмовних вставок, привітань чи вступів.
2. НЕ повторювати вхідні дані користувача.
3. ПОЧИНАТИ НЕГАЙНО із заголовка "## День 1".
4. ПІСЛЯ кожної назви страви вставляй фото за шаблоном: 
   ![image](https://loremflickr.com/600/400/food,[Dish_Name_English])
   (Замість [Dish_Name_English] пиши 1-2 простих англійських слова, що описують страву, наприклад: chicken,rice або eggs).
...
![image](https://loremflickr.com/600/400/food,[English_Keywords])
- Інгредієнти: [Список з точною вагою в грамах]
- Поживна цінність: [X] ккал | Білки: [X]г | Жири: [X]г | Вуглеводи: [X]г | Вітаміни: [Ключові вітаміни]
